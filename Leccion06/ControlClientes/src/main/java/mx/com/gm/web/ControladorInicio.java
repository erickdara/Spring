...
public class ControladorInicio {
     ...
     * 
     * 
     * @Valid esta anotación indica que se debe validar el objeto Persona y se antepone en los parametros del método
     * @param errores
     * Y en caso de que se tengan errores se debe pasar el Parametro Errors para saber si el formulario contiene errores 
     * Nota: Deben estar juntos estos parametros para mostrar correctamente los errores.
     * @param persona
     * @return 
     */
    @PostMapping("/guardar")
